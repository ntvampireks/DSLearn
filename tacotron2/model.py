...
class Decoder(nn.Module):
    def __init__(self, hparams):
        ...
        self.attention_rnn = nn.LSTMCell(
            hparams.prenet_dim + hparams.enc_aft_concat_voice_dim,
        ...
        self.gate_layer = LinearNorm(
            hparams.decoder_rnn_dim + hparams.enc_aft_concat_voice_dim, 1,
...
class Tacotron2(nn.Module):
    def __init__(self, hparams):
        ...
        self.embedding_voice = nn.Embedding(
    ...
    def parse_batch(self, batch):
        ...
        voice = to_gpu(voice).long()

        return (
            (text_padded, input_lengths, mel_padded, max_len, output_lengths, voice),
    ...
    def forward(self, inputs):
        ...
        mel_outputs, gate_outputs, alignments = self.decoder(
            concat_embs, mels, memory_lengths=text_lengths)
